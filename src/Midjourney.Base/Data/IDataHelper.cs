...
namespace Midjourney.Base.Data
{
    ...
    public interface IDataHelper<T> where T : IBaseId
    {
        ...
        IQuery<T> StreamQuery();

    }

    public interface IQuery<T>
    {
        IQuery<T> WhereIf(bool condition, Expression<Func<T, bool>> predicate);
        IQuery<T> OrderByIf(bool condition, Expression<Func<T, object>> keySelector, bool desc = true);
